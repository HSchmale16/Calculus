...
This method just bruteforces every single point to determine what color
that pixel will be. This method is the simpliest method to implement, but
it is also one of the slowest methods, becuase it is a brute force method.
